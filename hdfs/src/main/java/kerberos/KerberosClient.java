...
public class KerberosClient {
    public static void main(String[] args) throws Exception {
        ...
        System.setProperty("java.security.auth.login.config", "/Users/yanghuai/kerberos/local/jaas.conf");
        ...
        try {
            ...
            //登录的主体是conf的配置
            LoginContext context = new LoginContext("KafkaClient", null,
                    null, conf);


            //登录的主体是java.security.auth.login.config配置里查找到KafkaClient里的principal
//            LoginContext context = new LoginContext("KafkaClient");
            //权限认证
