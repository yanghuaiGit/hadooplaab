...
public final class InstantiationUtil {
    ...
    public static <T> T deserializeObject(InputStream in, ClassLoader cl, boolean isFailureTolerant)
        ...
        if (old instanceof ChildFirstCacheClassLoader
                && ((ChildFirstCacheClassLoader) old).isPluginClassLoader()) {
            cl = old;
        }
    ...
    public static class ClassLoaderObjectInputStream extends ObjectInputStream {
        ...
        protected ClassLoader currentCallStackClassLoader;
            ...
            if (classLoader != null) {
                ...
                try {
                    ...
                    FlinkUserCodeClassLoader pluginClassLoader =
                            ClassLoaderCacheManager.getPluginClassLoader(e, classLoader);
        ...
        private ClassLoader switchToCurrentCallStackClassLoader(ClassLoader classLoader) {
            if (currentCallStackClassLoader != null) {
                classLoader = currentCallStackClassLoader;
            }
            return classLoader;
        }
