...
import org.apache.flink.util.ChildFirstCacheClassLoader;
import org.apache.flink.util.ChildFirstClassLoader;
import org.apache.flink.util.ClassLoaderCacheManager;
...
public class FlinkUserCodeClassLoaders {
    ...
    public static URLClassLoader childFirstCache(
            URL[] urls,
            ClassLoader parent,
            String[] alwaysParentFirstPatterns,
            ...
            boolean checkClassLoaderLeak) {
        FlinkUserCodeClassLoader classloader =
                ClassLoaderCacheManager.getChunjunJobClassLoader(
                        urls,
                        parent,
    ...
    public enum ResolveOrder {
        ...
        public static ResolveOrder fromString(String resolveOrder) {
            if (resolveOrder.equalsIgnoreCase("parent-first")) {
                ...
                return CHILD_FIRST;
            } else if (resolveOrder.equalsIgnoreCase("child-first-cache")) {
                return CHILD_FIRST_CACHE;
            } else {
    ...
    public static class SafetyNetWrapperClassLoader extends URLClassLoader implements Closeable {
        ...
        public void close() {
            ...
            if (inner != null) {
                try {
                    if (!(inner instanceof ChildFirstCacheClassLoader)) {
                        inner.close();
                    }
                } catch (IOException e) {
        ...
        public FlinkUserCodeClassLoader ensureInner() {
            if (inner == null) {
