...
import org.example.util.DtStringUtil;
import org.example.util.PwdUtil;
import org.example.util.Splitter;
...
public class SqlParser {
                ...
                .forEach(
                        stmt -> {
                            try {
                                ...
                                throw new DtSqlParserException(
    ...
    private static AbstractStmtParser createParserChain() {
        ...
        AbstractStmtParser selectStmtParser = new SelectStmtParser();

        uploadFileStmtParser.setNextStmtParser(insertStmtParser);
        insertStmtParser.setNextStmtParser(selectStmtParser);
